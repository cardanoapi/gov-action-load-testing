    ...
    def test_info(
        ...
        * check the votes
        ...
        try:
            ...
            cc_keys = [r.hot_keys.hot_skey_file for r in governance_data.cc_key_members]
            ...
            cc_vote_output = conway_common.submit_vote(
                cluster_obj=cluster,
            ...
            drep_vote_output = conway_common.submit_vote(
                cluster_obj=cluster,
                name_template=temp_template,
                payment_addr=pool_user_ug.payment,
                votes=votes_drep,
            ...
            spo_vote_output = conway_common.submit_vote(
                cluster_obj=cluster,
                name_template=temp_template,
                payment_addr=pool_user_ug.payment,
                votes=votes_spo,
